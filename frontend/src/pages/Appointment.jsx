...
const Appointment = () => {
  ...
  const getavailableSlot =async () =>{
    ...
    for (let i = 0; i < 7; i++) {
      // getting date with index (0 = today, 1 = tomorrow, etc.)
      let currentDate = new Date(today)
      currentDate.setDate(today.getDate() + i)

      // setting end time of the date with index (e.g., 9 PM)
      ...
      if (today.getDate() === currentDate.getDate()) {
        // If it's **today**, we don’t allow booking in the past
        currentDate.setHours(currentDate.getHours() > 10 ? currentDate.getHours() + 1 : 10)
        currentDate.setMinutes(currentDate.getMinutes() > 30 ? 30 : 0)
      } else {
        // If it’s any future day, start slots from 10:00 AM
    ...
    <div>
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <p className='text-gray-500 font-medium mt-0'>
